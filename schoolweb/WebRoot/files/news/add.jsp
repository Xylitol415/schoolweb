...
<body class="ContentBody">
  <form action="NewsServlet?mtype=add" method="post"  name="form"  onSubmit="return checkValue()" >
<div class="MainDiv">
				...
				<legend>公告信息</legend>
					<table border="0" cellpadding="2" cellspacing="1" style="width:100%">
					  <tr>
					    ...
					    <input name='title' type="text" class="text" style="width:154px" value=""/>
				        *</span>
				        </td>
					  ...
					  <tr>
				        ...
				        *</span>
					    ...
					    <td width="35%"><span class="red">
					    <textarea name='xiangqing' rows="4" cols="40"></textarea>
				        *</span>
				        </td>
					  </tr>
					  </table>
