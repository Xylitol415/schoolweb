...
<body class="ContentBody">
  <form action="SonnoticeServlet?mtype=update" method="post"  name="form"  onSubmit="return checkValue()" >
<div class="MainDiv">
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  ...
  <tr>
      <td align="left" ><font color="blue">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;修改支部信息</font></td>
  </tr>
  <tr>
    <td class="CPanel">		
		...
		<tr>
			<td width="100%">
				...
				<legend>支部信息</legend>
				     <input name='id' type="hidden" class="text" style="width:154px" value="${sonnotice.id }"/>
				     <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
					  <tr>
					    ...
					    <select name="typeid1" disabled="disabled">
					    	...
					    	<input name='typeid'  type="hidden" class="text" style="width:154px" value="${sonnotice.typeid }"/>
				        *</span>
				        </td>
					    <td align="right" width="19%">支部名称:</td>
					    <td width="35%"><span class="red">
					    <input name='typename' type="text" class="text" style="width:154px" value="${sonnotice.typename }"/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='rusun' type="text" class="text" style="width:154px" value="${sonnotice.rusun }"/>
				        *</span>
				        </td>
					    <td align="right" width="19%">党员总数:</td>
					    <td width="35%"><span class="red">
				        <input name='dangsun' type="text" class="text" style="width:154px" value="${sonnotice.dangsun }"/>
				        *</span>
				        </td>
					  </tr>					 
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='username' type="text" class="text" style="width:154px" value="${sonnotice.username }"/>
				        *</span>
				        </td>
					    <td align="right" width="19%">办公电话:</td>
					    <td width="35%"><span class="red">
				        <input name='tel' type="text" class="text" style="width:154px" value="${sonnotice.tel }"/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='phone' type="text" class="text" style="width:154px" value="${sonnotice.phone }"/>
				        *</span>
				        </td>
					    <td align="right" width="19%">电子邮箱:</td>
					    <td width="35%"><span class="red">
				        <input name='email' type="text" class="text" style="width:154px" value="${sonnotice.email }"/>
				        *</span>
				        </td>
					  </tr>
					  </table>
