...
<body class="ContentBody">
  <form action="DangfeiServlet?mtype=update" method="post"  name="form"  onSubmit="return checkValue()" >
<div class="MainDiv">
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  ...
  <tr>
      <td align="left" ><font color="blue">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;修改党费信息</font></td>
  </tr>
  <tr>
    <td class="CPanel">		
		...
		<tr>
			<td width="100%">
				...
				<legend>党费信息</legend>
				     <input name='id' type="hidden" class="text" style="width:154px" value="${dangfei.id }"/>
				     <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
					  <tr>
					    ...
					    <select name="typeid1" disabled="disabled">
					    	...
					    	<input name='typeid'  type="hidden" class="text" style="width:154px" value="${dangfei.typeid }"/>
				        *</span>
				        </td>
					    <td align="right" width="19%">支部名称:</td>
					    <td width="35%"><span class="red">
					    <input name='typename'  type="text" class="text" style="width:154px" value="${dangfei.typename }"/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='username' type="text" class="text" style="width:154px" value="${dangfei.username }"/>
				        *</span>
				        </td>
					    <td align="right" width="19%">班级:</td>
					    <td width="35%"><span class="red">
				        <input name='classname' type="text" class="text" style="width:154px" value="${dangfei.classname }"/>
				        *</span>
				        </td>
					  </tr>					 
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='dangtype' type="text" class="text" style="width:154px" value="${dangfei.dangtype }"/>
				        *</span>
				        </td>
					    <td align="right" width="19%">党费收缴年度:</td>
					    <td width="35%"><span class="red">
				        <input name='shouyear' type="text" class="text" style="width:154px" value="${dangfei.shouyear }"/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='dangfei' type="text" class="text" style="width:154px" value="${dangfei.dangfei }"/>
				        *</span>
				        </td>
