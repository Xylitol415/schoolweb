...
<body class="ContentBody">
  <form action="StudentzhServlet?mtype=add" method="post"  name="form"  onSubmit="return checkValue()" >
<div class="MainDiv">
					...
					<table border="0" cellpadding="2" cellspacing="1" style="width:100%">
					  ...
					  <tr>
				        ...
				        *</span>
					    ...
					    <td width="35%"><span class="red">
				        <input name='nation' type="text" class="text" style="width:154px" value=""/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='place' type="text" class="text" style="width:154px" value=""/>
				        *</span>
				        </td>
					    <td align="right" width="19%">出生日期:</td>
					    <td width="35%"><span class="red">
				        <input name='barthday' type="text" class="Wdate date-font12-333" onClick="WdatePicker({})" size="12" maxlength="15" style="border: solid 1px #ccc;width: 100px" size="40" value=""/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input type="text" name="rudate" id="rudate" class="Wdate date-font12-333" onClick="WdatePicker({})" size="12" maxlength="15" style="border: solid 1px #ccc;width: 100px" size="40"  > 
				        *</span>
				        </td>
				        <td align="right" width="19%">列积极分子时间:</td>
					    <td width="35%"><span class="red">
				        <input type="text" name="fenzhi" id="fenzhi" class="Wdate date-font12-333" onClick="WdatePicker({})" size="12" maxlength="15" style="border: solid 1px #ccc;width: 100px" size="40"  > 
				        *</span>
				        </td>					   				    
					  </tr>
					  <tr>
					    ...
					    <td width="35%"><span class="red">
					    <input type="text" name="fadate" id="fadate" class="Wdate date-font12-333" onClick="WdatePicker({})" size="12" maxlength="15" style="border: solid 1px #ccc;width: 100px" size="40"  > 
				        *</span>
				        </td>
					    <td align="right" width="19%">接收时间:</td>
					    <td width="35%"><span class="red">
					    <input type="text" name="jiedate" id="jiedate" class="Wdate date-font12-333" onClick="WdatePicker({})" size="12" maxlength="15" style="border: solid 1px #ccc;width: 100px" size="40"  > 
				        *</span>
				        </td>
					  </tr>
					  <tr>
					    ...
					    <td width="35%"><span class="red">
					    <input type="text" name="zhuandate" id="zhuandate" class="Wdate date-font12-333" onClick="WdatePicker({})" size="12" maxlength="15" style="border: solid 1px #ccc;width: 100px" size="40"  > 
				        *</span>
				        </td>
					    <td align="right" width="19%">思想汇报:</td>
					    <td width="35%"><span class="red">
				        <input name='sixiang' type="text" class="text" style="width:154px" value=""/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
					    ...
					    <td width="35%"><span class="red">
					    <input name='jieuser' type="text" class="text" style="width:154px" value=""/>
				        *</span>
				        </td>
					    <td align="right" width="19%">支部决议:</td>
					    <td width="35%"><span class="red">
				        <input name='jueyi' type="text" class="text" style="width:154px" value=""/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='idcard' type="text" class="text" style="width:154px" value=""/>
				        *</span>
				        </td>
					    <td align="right" width="19%"></td>
					    <td width="35%"><span class="red">
					    <input name='status' type="hidden" class="text" style="width:154px" value="待批准"/>
				        </span>
				        </td>
					  </tr>
					  </table>
