...
<script type="text/javascript">
		function checkValue(){
				...
				console.log(document.form.idcard.value);
				...
				var date6 = new Date(document.form.zhuandate.value);
				var s6 = date6.getTime();
				var total = (s6 - s5)/1000;
				var day4 = parseInt(total / (24*60*60));//计算整数天数
				console.log(day4>0);
				if(day4<0){
					alert("转正时间应大于接收时间！");
					return false;
...
<body class="ContentBody">
  <form action="StudentzhServlet?mtype=update" method="post"  name="form"  onSubmit="return checkValue()" >
<div class="MainDiv">
				     ...
				     <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
					  <tr>
					    ...
					    <select name="typeid1" disabled="disabled">
					    	...
					    	<input name='typeid'  type="hidden" class="text" style="width:154px" value="${studentzh.typeid}"/>
				        *</span>
				        </td>
					    <td align="right" width="19%">所属支部:</td>
					    <td width="35%"><span class="red">
					    <input name='typename'  type="text" class="text" style="width:154px" value="${studentzh.typename}"/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='username' type="text" class="text" style="width:154px" value="${studentzh.username}"/>
				        *</span>
				        </td>
					    <td align="right" width="19%">班级:</td>
					    <td width="35%"><span class="red">
				        <input name='classname' type="text" class="text" style="width:154px" value="${studentzh.classname}"/>
				        *</span>
				        </td>
					  </tr>					 
					  <tr>
					    ...
					    <td width="35%"><span class="red">
					    <select name='sex'>
					    	<option <c:if test="${studentzh.sex=='男' }"> selected="selected"</c:if> value="男">男</option>
					    	<option <c:if test="${studentzh.sex=='女' }"> selected="selected"</c:if> value="女">女</option>
					    </select>
				        *</span>
				        </td>
					    <td align="right" width="19%">民族:</td>
					    <td width="35%"><span class="red">
				        <input name='nation' type="text" class="text" style="width:154px" value="${studentzh.nation}"/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='place' type="text" class="text" style="width:154px" value="${studentzh.place}"/>
				        *</span>
				        </td>
					    <td align="right" width="19%">出生日期:</td>
					    <td width="35%"><span class="red">
					    <input type="text" name="barthday" id="barthday" value="${studentzh.barthday}" class="Wdate date-font12-333" onClick="WdatePicker({})" size="12" maxlength="15" style="border: solid 1px #ccc;width: 100px" size="40"  > 
				        *</span>
				        </td>
					  </tr>
					  <tr>										    
					    ...
					    <td width="35%"><span class="red">
					    <input type="text" name="rudate" id="rudate" value="${studentzh.rudate}" class="Wdate date-font12-333" onClick="WdatePicker({})" size="12" maxlength="15" style="border: solid 1px #ccc;width: 100px" size="40"  > 
				        *</span>
				        </td>
				        <td align="right" width="19%">列积极分子时间:</td>
					    <td width="35%"><span class="red">
					    <input type="text" name="fenzhi" id="fenzhi" value="${studentzh.fenzhi}"  class="Wdate date-font12-333" onClick="WdatePicker({})" size="12" maxlength="15" style="border: solid 1px #ccc;width: 100px" size="40"  > 
				        *</span>
				        </td>
					  </tr>
					  <tr>
					    ...
					    <td width="35%"><span class="red">
					    <input type="text" name="fadate" id="fadate" value="${studentzh.fadate}" class="Wdate date-font12-333" onClick="WdatePicker({})" size="12" maxlength="15" style="border: solid 1px #ccc;width: 100px" size="40"  > 
				        *</span>
				        </td>
					    <td align="right" width="19%">接收时间:</td>
					    <td width="35%"><span class="red">
					    <input type="text" name="jiedate" id="jiedate" value="${studentzh.jiedate}" class="Wdate date-font12-333" onClick="WdatePicker({})" size="12" maxlength="15" style="border: solid 1px #ccc;width: 100px" size="40"  > 
				        *</span>
				        </td>
					  </tr>
					  <tr>
					  	<td align="right" width="19%">转正时间:</td>
					    <td width="35%"><span class="red">
					    <input type="text" name="zhuandate" id="zhuandate" value="${studentzh.zhuandate}" class="Wdate date-font12-333" onClick="WdatePicker({})" size="12" maxlength="15" style="border: solid 1px #ccc;width: 100px" size="40"  > 
				        *</span>
				        </td>
					    <td align="right" width="19%">思想汇报:</td>
					    <td width="35%"><span class="red">
				        <input name='sixiang' type="text" class="text" style="width:154px" value="${studentzh.sixiang}"/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
					    ...
					    <td width="35%"><span class="red">
					    <input name='jieuser' type="text" class="text" style="width:154px" value="${studentzh.jieuser}"/>
				        *</span>
				        </td>
					    <td align="right" width="19%">支部决议:</td>
					    <td width="35%"><span class="red">
				        <input name='jueyi' type="text" class="text" style="width:154px" value="${studentzh.jueyi}"/>
				        *</span>
				        </td>
					  </tr>
					  ...
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='idcard' type="text" class="text" style="width:154px" value="${studentzh.idcard}"/>
				        *</span>
				        </td>
					    <td align="right" width="19%"></td>
					    <td width="35%"><span class="red">
					    <input name='status' type="hidden" class="text" style="width:154px" value="${studentzh.status}"/>
				        </span>
				        </td>
					  </tr>
					  </table>
