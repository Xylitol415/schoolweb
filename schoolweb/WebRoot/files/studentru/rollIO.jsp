...
<body class="ContentBody">
  <form action="StudentruServlet?mtype=rollio" method="post"  name="form"  onSubmit="return checkValue()" >
<div class="MainDiv">
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  ...
  <tr>
      <td align="left" ><font color="blue">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;申请转出信息</font></td>
  </tr>
  <tr>
    <td class="CPanel">		
				     ...
				     <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
					  <tr>
				        ...
				        *</span>
					    ...
					    <td width="35%"><span class="red">
					    <input name='newtname'  type="text" class="text" style="width:154px" value="${studentru.typename}"/>
