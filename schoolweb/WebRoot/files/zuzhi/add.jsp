...
<body class="ContentBody">
  <form action="ZuzhiServlet?mtype=add" method="post"  name="form"  onSubmit="return checkValue()" >
<div class="MainDiv">
				...
				<legend>组织信息</legend>
					<table border="0" cellpadding="2" cellspacing="1" style="width:100%">
					  ...
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='huoname' type="text" class="text" style="width:154px" value=""/>
				        *</span>
				        </td>
					  ...
					  <tr>
					    ...
					    <td width="35%"><span class="red">
					     <input type="text" name="huodate" id="huodate" class="Wdate date-font12-333" onClick="WdatePicker({})" size="12" maxlength="15" style="border: solid 1px #ccc;width: 100px" size="40"  > 
				        *</span>
				        </td>
					    <td align="right" width="19%">参与人数:</td>
					    <td width="35%"><span class="red">
				        <input name='csum' type="text" class="text" style="width:154px" value=""/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='huouser' type="text" class="text" style="width:154px" value=""/>
				        *</span>
				        </td>
					  ...
					  <tr>
					    ...
					    <td width="35%"><span class="red">
					    <input name='xiangqing' type="text" class="text" style="width:154px" value=""/>
				        *</span>
				        </td>
