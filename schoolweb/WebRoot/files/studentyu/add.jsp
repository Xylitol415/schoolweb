...
<body class="ContentBody">
  <form action="StudentyuServlet?mtype=add" method="post"  name="form"  onSubmit="return checkValue()" >
<div class="MainDiv">
					...
					<table border="0" cellpadding="2" cellspacing="1" style="width:100%">
					  ...
					  <tr>
				        ...
				        *</span>
					    ...
					    <td width="35%"><span class="red">
				        <input name='fenzhi' type="text" class="Wdate date-font12-333" onClick="WdatePicker({})" size="12" maxlength="15" style="border: solid 1px #ccc;width: 100px" size="40" value=""/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
				        ...
				        *</span>
					    ...
					    <td width="35%"><span class="red">
					    <input name='jiedate' type="text" class="Wdate date-font12-333" onClick="WdatePicker({})" size="12" maxlength="15" style="border: solid 1px #ccc;width: 100px" size="40" value=""/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
