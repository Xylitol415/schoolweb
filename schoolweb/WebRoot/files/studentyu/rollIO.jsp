...
<body class="ContentBody">
  <form action="StudentyuServlet?mtype=rollio" method="post"  name="form"  onSubmit="return checkValue()" >
<div class="MainDiv">
				     ...
				     <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
					  <tr>
				        ...
				        *</span>
					    ...
					    <td width="35%"><span class="red">
					    <input name='newtname'  type="text" class="text" style="width:154px" value="${studentyu.typename}"/>
